...
static BtnState_t state_idle(ButtonSM_t *sm, BtnEvent_t e)
{
    ...
    switch (e) {
        ...
        case EVT_TIMER_EXP:
            ...
            // Timer is started only inside on_enter_DEBOUNCING.
            // To reach IDLE the machine must have left DEBOUNCING,
...
static BtnState_t state_pressed(ButtonSM_t *sm, BtnEvent_t e)
{
    ...
    switch (e) {
        ...
        case EVT_TIMER_EXP:
            ...
            // Impossible in this state.
            // Timer is started only inside on_enter_DEBOUNCING.
            // To reach PRESSED the machine must have left DEBOUNCING
            // via EVT_TIMER_EXP — that event is consumed there and
            // the timer is not re-armed until the next edge arrives.
            // Defensive: stay pressed.
